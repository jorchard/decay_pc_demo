...
class PELayer:
    ...
    def Load(self, fp):
        self.n = np.load(fp).item()
        self.is_input = np.load(fp).item()
        self.is_top = np.load(fp).item()
        self.is_rf = np.load(fp).item()
        self.variance = np.load (fp).item()
...
class RetinotopicPELayer(PELayer):
    ...
    def Load(self, fp):
        self.channels = np.load(fp).item()
        self.receptive_field = np.load(fp).item()
        self.receptive_field = (int(self.receptive_field[0]), int(self.receptive_field[1]))
        self.receptive_field_spacing = np.load(fp).item()
        self.height = np.load(fp).item()
        self.width = np.load(fp).item()
        self.n = np.load(fp).item()
        self.is_input = np.load(fp).item()
        self.is_top = np.load(fp).item()
        self.is_rf = np.load(fp).item()
